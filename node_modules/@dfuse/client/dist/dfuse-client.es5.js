...
function createDfuseClient(options) {
    ...
    return new DefaultClient(options.apiKey, endpoints, httpClient, streamClient, graphqlStreamClient, apiTokenStore, refreshScheduler, requestIdGenerator);
}
 ...
 */
class DefaultClient {
    constructor(apiKey, endpoints, httpClient, streamClient, graphqlStreamClient, apiTokenStore, refreshScheduler, requestIdGenerator) {
        this.debug = debugFactory("dfuse:client");
        this.withDefaultOptions = (options) => {
            return Object.assign({ req_id: this.requestIdGenerator() }, options);
        };
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (onMessageProvided) {
                return this.withApiToken((apiTokenInfo) => {
                    ...
                    return this.graphqlStreamClient.registerStream(this.requestIdGenerator(), 
